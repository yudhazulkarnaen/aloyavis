        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="card shadow mb-3">
                                    <div class="steps-progressbar">
                                        <ul>
                                            ...
                                            <li class="previous">FORM QUICK MAINTENANCE CHECKSHEET</li>
                                            <li class="active">CUCI KENDARAAN</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <h3 class="text-dark mb-1">CUCI KENDARAAN</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 fw-bold">Cuci Kendaraan "<?= $res['merk_kendaraan_wo'] ?> - <?= $res['nomor_polisi_wo'] ?>"</p>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <div class="col">
                                                            <div class="mb-3"><label class="form-label" for="username" style="margin-bottom: 15px;"><br></label>
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered">
                                                                        <thead>
                                                                            <tr>
                                                                                <th class="table-primary text-center text-bg-primary">NAMA KEGIATAN</th>
                                                                                <th class="table-primary text-center text-bg-primary" style="width: 170px;">DIKERJAKAN</th>
                                                                                <th class="table-primary text-center text-bg-primary" style="width: 170px;">TIDAK DIKERJAKAN</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>Cuci Kendaraan</td>
                                                                                <td class="text-center"><input type="radio" id="q156" value="Dikerjakan" name="cucikendaraan"></td>
                                                                                <td class="text-center"><input type="radio" id="q156" value="Tidak Dikerjakan" name="cucikendaraan"></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                            ...
                                            <div class="text-center mb-3"><button class="btn btn-primary btn-sm" type="submit"><i class="fas fa-play"></i>&nbsp; Simpan Data &amp; Selesai Proses Servis</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
