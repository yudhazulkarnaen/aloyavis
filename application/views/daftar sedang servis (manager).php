        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_manager') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= base_url('c_manager/daftarsedangservis') ?>"><strong>Daftar Sedang Servis</strong></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card" style="margin-top: 10px;">
                        <form class="search-form" action="<?= base_url('c_manager/daftarsedangservis'); ?>" method="post">
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr class="table-primary">
                                        <th class="text-center" style="width: 10%;">Nomor Pit</th>
                                        <th>No. Polisi</th>
                                        <th>Nama Pemilik</th>
                                ...
                                <?php 
                                    foreach ($res as $a) : ?>
                                    <tr>
                                        <td class="text-center"><?= $a['nomor_pitstop']; ?></td>
