...
<head>
    ...
    <title>Daftar Harga Servis</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">DAFTAR HARGA SERVIS</h3>
                    <div class="card" style="margin-top: 10px;">
                        <form class="search-form" action="<?= base_url('c_manager/daftarhargaservis'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Merk Kendaraan" name="keyword_hargaservis" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Merk Kendaraan = <?php echo $total_rows ?></strong><br></p>
                                <?php echo $wew ?>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr class="table-primary">
                                        ...
                                        <th class="text-center">Lihat Harga Servis</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php if (empty($res)) : ?>
                                ...
                                foreach ($res as $a) :?>
                                    <tr>
                                        ...
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['merk_kendaraan']; ?></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;" class="text-center"><?= $a['isi_silinder']; ?> CC</td>
                                        <td class="text-start text-center"><a class="btn btn-primary" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailhargaservis/').$a['merk_kendaraan'].'/'.$a['isi_silinder'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Harga</a></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
