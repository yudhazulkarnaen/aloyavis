        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_karu') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="<?= base_url('c_karu') ?>">Beranda</a></li>
                                    ...
                                    <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                                        ...
                                        <div class="col">
                                            <div class="text-center border rounded d-flex flex-column align-items-center align-items-xl-center" style="padding: 15px;background: #eaf0ff;">
                                                ...
                                                <div class="px-3">
                                                    <h4>Monitoring Servis</h4>
                                                    <p>Halaman berisi kendaraan yang perlu dilakukan servis hari ini.</p><a href="<?= base_url('c_karu/monitoringservis') ?>" style="color: rgb(246,50,34);">Menuju Halaman&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-right">
