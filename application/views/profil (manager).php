                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="text-center mb-3"><a class="btn btn-secondary btn-sm" style="margin-right: 10px;" href="<?= base_url('c_manager') ?>"><i class="fas fa-home"></i>&nbsp; Kembali ke Halaman Utama</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
