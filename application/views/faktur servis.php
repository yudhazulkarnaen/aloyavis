                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="text-center mb-3"><button class="btn btn-secondary btn-sm" type="submit" onclick="window.print()" style="margin-right: 10px;"><i class="fas fa-print"></i>&nbsp; Print Faktur Servis</button><a class="btn btn-primary btn-sm" role="button" href="<?= base_url('c_serviceadvisor/daftarselesaiservis') ?>"><i class="fas fa-backward"></i>&nbsp; Kembali</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
