                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        ...
                                        <?= $this->session->flashdata('message'); ?>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Username</strong><br></label><input class="form-control" type="text" id="username" placeholder="Username Anda" value="<?= $res['username'] ?>" readonly name="username"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Nama Lengkap</strong><br></label><input class="form-control" type="text" id="username-2" placeholder="Nama Lengkap Anda" value="<?= $res['nama'] ?>" readonly name="nama"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Nomor Pegawai</strong><br></label><input class="form-control" type="number" id="username-1" placeholder="Nomor Pegawai Anda" value="<?= $res['nip'] ?>" readonly name="nip"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>No. Handphone</strong><br></label><input class="form-control" type="number" id="username-7" placeholder="Nomor Handphone Anda" value="0<?= $res['handphone'] ?>" readonly name="handphone"></div>
                                                </div>
                                            </div>
                                            <div class="text-center mb-3"><a class="btn btn-secondary btn-sm" type="button" style="margin-right: 10px;" href="<?= base_url('c_serviceadvisor') ?>"><i class="fas fa-home"></i>&nbsp; Kembali ke Halaman Utama</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
