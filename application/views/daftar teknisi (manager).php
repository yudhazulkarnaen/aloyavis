        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">DAFTAR TEKNISI</h3>
                    <div class="card" style="margin-top: 10px;">
                    <form class="search-form" action="<?= base_url('c_manager/daftarteknisi'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Nama Teknisi" name="keyword_teknisi" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Teknisi = <?php echo $jmlteknisi ?></strong><br></p>
                                <?php echo $wew ?>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr class="table-primary">
                                        ...
                                        <th>Nomor Pit</th>
                                        <th>Tugas Teknisi</th>
                                        <th>Jumlah Servis Dikerjakan</th>
                                        <th>History Pekerjaan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php if (empty($res)) : ?>
                            	...
                            	<?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['teknisi_a']; ?></td>
                                        <td class="text-center" style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['nomor_pitstop']; ?></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;">Teknisi A</td>
                                        <td class="text-center" style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['duplicate_value']; ?></td>
                                        <td style="color: rgb(0,0,0);"><a class="btn btn-primary" role="button" href="<?= base_url('c_manager/historypekerjaanteknisi_a/').$a['teknisi_a'] ?>">Lihat History Pekerjaan</a></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: center;color: rgb(0,0,0);vertical-align: middle;"><?= $no++; ?>.</td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['teknisi_b']; ?></td>
                                        <td class="text-center" style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['nomor_pitstop']; ?></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;">Teknisi B</td>
                                        <td class="text-center" style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['duplicate_value']; ?></td>
                                        <td style="color: rgb(0,0,0);"><a class="btn btn-primary" role="button" href="<?= base_url('c_manager/historypekerjaanteknisi_b/').$a['teknisi_b'] ?>">Lihat History Pekerjaan</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
