        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="steps-progressbar">
                                        <ul>
                                            <li class="active">PENYERAHAN WORKORDER</li>
                                            <li>PENGERJAAN TASK LIST</li>
                    ...
                    <h3 class="text-dark mb-1">MONITORING SERVIS</h3>
                    <div class="col">
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if (empty($res)) : ?>
                                            <div class="alert alert-danger" role="alert">
                                                Belum ada kendaraan untuk di servis!
                                            </div>
                                        <?php endif; ?>
                                        <?php if (!empty($res)) : ?>
                                            <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 200px;">NOMOR PIT</td>
                                                                        <td><?= $res['nomor_pitstop'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 140px;">NOMOR POLISI</td>
                                                                        <td><?= $res['nomor_polisi'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 140px;">KEPALA REGU</td>
                                                                        <td><?php $myname = $this->session->userdata('nama'); echo $myname; ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">TEKNISI A</td>
                                                                        <td><?php $mymontir = $this->session->userdata('teknisi_a'); echo $mymontir; ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">TEKNISI B</td>
                                                                        <td><?php $mymontir = $this->session->userdata('teknisi_b'); echo $mymontir; ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">WAKTU SERVIS</td>
                                                                        <td><?= $res['jam_servis'] ?> s/d <?php echo $estimasiselesai; ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">LIHAT INFO KENDARAAN<br></td>
                                                                        <td style="text-align: center;"><a class="btn btn-success" type="button" href="<?= base_url('c_karu/infokendaraan/').$res['nomor_polisi'] ?>"><i class="fas fa-search-plus"></i>&nbsp;Lihat Info Kendaraan</a></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">LIHAT FORM PEMERIKSAAN<br></td>
                                                                        <td style="text-align: center;"><a class="btn btn-success" type="button" href="<?= base_url('c_karu/infopemeriksaan/').$res['nomor_polisi'] ?>"><i class="fas fa-search-plus"></i>&nbsp;Lihat Form Pemeriksaan</a></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">LIHAT FORM WORK ORDER/PKB<br></td>
                                                                        <td style="text-align: center;"><a class="btn btn-success" type="button" href="<?= base_url('c_karu/infoworkorder/').$res['nomor_polisi'] ?>"><i class="fas fa-search-plus"></i>&nbsp;Lihat Form Work Order/PKB</a></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                            ...
                                            <div class="text-center mb-3"><a class="btn btn-primary btn-sm" type="button" href="<?= base_url('c_karu/tasklist/').$res['nomor_polisi'] ?>"><i class="fas fa-play"></i>&nbsp; Mulai Pengerjaan Task List</a></div>
                                        <?php endif; ?>
