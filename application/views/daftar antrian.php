        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1" style="margin-top: 20px;">DAFTAR ANTRIAN</h3>
                    <div class="card" style="margin-top: 10px;">
                        <form class="search-form" action="<?= base_url('c_serviceadvisor/daftarantrian'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Plat Nomor" name="keyword_daftarantrian" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Antrian = 
                                <?php echo $total_rows ?>
                                </strong><br><strong>Tanggal&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;= <?php echo $date; ?></strong></p>
                                <?php echo $wew ?>
                            </div>
                            <div class="col-md-6" style="text-align: right;"><a class="btn btn-primary" role="button" href="<?= base_url('c_serviceadvisor/tambahAntrian') ?>">Tambah Antrian&nbsp;<i class="fas fa-plus"></i></a></div>
                        </div>
                            	...
                            	<?php endif; ?>
                                    ...
                                    foreach ($res as $a) :
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $a['jam_servis']; ?></td>
                                            <!-- <td><?= $base; ?></td> -->
                                            <td><a class="btn btn-success" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_serviceadvisor/detailAntrian/').$a['plat_nomor'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Antrian</a></td>
                                            <?php if ($a['status'] == "pemeriksaan" or $a['status'] == "work order") { ?>
                                                <td><a class="btn btn-danger tombol-hapus" type="button" style="color: rgb(255,255,255);" href="<?= base_url('c_serviceadvisor/hapusAntrian/').$a['no_antrian'] ?>"><i class="fas fa-trash"></i>&nbsp;Cancel Servis</a></td>
                                            <?php } else if ($a['no_antrian'] == 0) { ?>
                                                <td><a class="btn btn-secondary" role="button" disabled>MOBIL SUDAH SERVIS</a></td>
                                            <?php } else { ?>
                                                <td><a class="btn btn-secondary" role="button" disabled>MOBIL SEDANG SERVIS</a></td>
                                            <?php } ?>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
