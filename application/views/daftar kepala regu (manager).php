...
<head>
    ...
    <title>Daftar Kepala Regu</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">DAFTAR KEPALA REGU</h3>
                    <div class="card" style="margin-top: 10px;">
                        <form class="search-form" action="<?= base_url('c_manager/daftarkepalaregu'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Nama Kepala Regu" name="keyword_kepalaregu" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Kepala Regu = <?php echo $jmlkepalaregu ?></strong><br></p>
                                <?php echo $wew ?>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                            	...
                            	<?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['nama']; ?></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: initial;"><?= $a['nip']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;">0<?= $a['handphone']; ?></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['nomor_pitstop']; ?></td>
                                        ...
                                        <td style="color: rgb(0,0,0);"><a class="btn btn-primary" role="button" href="<?= base_url('c_manager/historypekerjaankepalaregu/').$a['nama'] ?>">Lihat History Pekerjaan</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
