                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="text-center mb-3"><button class="btn btn-secondary btn-sm" type="button" style="margin-right: 10px;" onclick="window.print()"><i class="fas fa-print"></i>&nbsp; Print QMC</button><a class="btn btn-primary btn-sm" role="button" href="<?= base_url('c_serviceadvisor/daftarselesaiservis') ?>"><i class="fas fa-backward"></i>&nbsp; Kembali</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
