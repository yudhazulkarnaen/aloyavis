                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 200px;">NOMOR ANTRIAN</td>
                                                                        <td><?= $res['no_antrian'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 140px;">JAM SERVIS</td>
                                                                        <td><?= $res['jam_servis'] ?> s/d <?php echo $estimasiselesai;?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">TANGGAL SERVIS</td>
                                                                        <td><?= $res['tgl_antrian'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">STATUS SERVIS</td>
                                                                        <td><?= $res['status'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">NAMA PEMILIK</td>
                                                                        <td><?= $res2['nama_pemilik'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">ALAMAT KENDARAAN</td>
                                                                        <td><?= $res2['alamat_pemilik'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">NOMOR TELEPON</td>
                                                                        <td><?= $res2['nomor_telepon'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">NOMOR HANDPHONE</td>
                                                                        <td>0<?= $res2['nomor_handphone'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">MERK KENDARAAN</td>
                                                                        <td><?= $res2['merk_kendaraan'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">TAHUN KENDARAAN</td>
                                                                        <td><?= $res2['tahun_kendaraan'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">WARNA KENDARAAN</td>
                                                                        <td><?= $res2['warna_kendaraan'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">ISI SILINDER</td>
                                                                        <td><?= $res2['isi_silinder'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">NOMOR CHASIS</td>
                                                                        <td><?= $res2['nomor_chasis'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary">NOMOR MESIN</td>
                                                                        <td><?= $res2['nomor_mesin'] ?></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                            ...
                                            <div class="text-center mb-3"><a class="btn btn-primary btn-sm" type="button" href="<?= base_url('c_serviceadvisor/daftarantrian') ?>"><i class="fas fa-backward"></i>&nbsp; Kembali</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
