...
<head>
    ...
    <title>History Pekerjaan Teknisi</title>
        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_manager') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= base_url('c_manager/daftarteknisi') ?>"><strong>Daftar Teknisi</strong></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">HISTORY PEKERJAAN</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 fw-bold">History Pekerjaan Teknisi "<?php echo $nama ?>"</p>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <div class="row">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered">
                                                                        <thead>
                                                                            <tr>
                                                                                <th class="table-primary text-center text-bg-primary">NO.</th>
                                                                                <th class="table-primary text-center text-bg-primary">PLAT NOMOR</th>
                                                                                <th class="table-primary text-center text-bg-primary" style="background: rgb(78, 115, 223);">TANGGAL</th>
                                                                                <th class="table-primary text-center text-bg-primary" style="width: 20%;">DETAIL PEMERIKSAAN</th>
                                                                                <th class="table-primary text-center text-bg-primary" style="width: 20%;">DETAIL WORKORDER</th>
                                                                                <th class="table-primary text-center text-bg-primary" style="width: 20%;">DETAIL QMC</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                        <?php 
                                                                        ...
                                                                        foreach ($res as $a) : ?>
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: center;"><?= $a['nomor_polisi_selesai']; ?></td>
                                                                                <td class="text-center"><?= $a['tgl']; ?></td>
                                                                                <td class="text-center"><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailpemeriksaan/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Pemeriksaan</a></td>
                                                                                <td class="text-center"><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailworkorder/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Work Order</a></td>
                                                                                <td class="text-center"><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailqmc/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail QMC</a></td>
                                                                            </tr>
                                                                        <?php endforeach; ?>
                                                                        </tbody>
                                                                    </table>
                                            ...
                                            <div class="text-center mb-3"><a class="btn btn-primary btn-sm" role="button" href="<?= base_url('c_manager/daftarteknisi') ?>"><i class="fas fa-backward"></i>&nbsp; Kembali</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
