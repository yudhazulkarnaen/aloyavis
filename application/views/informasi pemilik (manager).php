        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">INFORMASI PEMILIK KENDARAAN</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 30%;vertical-align: middle;">PLAT NOMOR</td>
                                                                        <td><input class="form-control" type="text" readonly="" value="<?= $res['nomor_polisi'] ?>" style="text-align: center;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 30%;vertical-align: middle;">NAMA PEMILIK</td>
                                                                        <td><input class="form-control" type="text" readonly="" value="<?= $res['nama_pemilik'] ?>" style="text-align: center;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 30%;vertical-align: middle;">ALAMAT PEMILIK</td>
                                                                        <td><input class="form-control" type="text" readonly="" value="<?= $res['alamat_pemilik'] ?>" style="text-align: center;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 30%;vertical-align: middle;">NOMOR HANDPHONE</td>
                                                                        <td><input class="form-control" type="text" readonly="" value="0<?= $res['nomor_handphone'] ?>" style="text-align: center;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 30%;vertical-align: middle;">NOMOR TELEPON</td>
                                                                        <td><input class="form-control" type="text" readonly="" value="0<?= $res['nomor_telepon'] ?>" style="text-align: center;"></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                            ...
                                            <div class="text-center mb-3"><a class="btn btn-primary btn-sm" role="button" href="<?= base_url('c_manager/daftarkendaraan') ?>"><i class="fas fa-backward"></i>&nbsp; Kembali</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
