        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">INFO KENDARAAN</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="table-primary" style="width: 200px;">NOMOR POLISI</td>
