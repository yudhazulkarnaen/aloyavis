        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">GANTI PASSWORD</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        ...
                                        <?= $this->session->flashdata('message'); ?>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Password Lama</strong><br></label><input class="form-control" type="password" id="username" placeholder="Password Lama Anda" name="oldpassword"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Password Baru</strong><br></label><input class="form-control" type="password" id="username-1" placeholder="Password Baru Anda" name="password1"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Ulangi Password Baru</strong><br></label><input class="form-control" type="password" id="username-3" placeholder="Ulangi Password Baru Anda" name="password2"></div>
                                                </div>
                                            </div>
                                            <div class="text-center mb-3"><a class="btn btn-secondary btn-sm" style="margin-right: 10px;" href="<?= base_url('c_karu') ?>"><i class="fas fa-home"></i>&nbsp; Kembali ke Halaman Utama</a><button class="btn btn-primary btn-sm" type="submit"><i class="fas fa-save"></i>&nbsp; Simpan Perubahan</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
