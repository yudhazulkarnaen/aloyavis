...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_serviceadvisor') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= base_url('c_serviceadvisor/daftarantrian') ?>"><strong>Daftar Antrian</strong></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">TAMBAH ANTRIAN</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Tanggal</strong><br></label><input class="form-control" id="username-1" name="tglservis" id="tglservis" placeholder="Nomor Polisi Sesuai STNK" type="date" value="<?php echo $date; ?>" readonly="" style="background: rgb(234,236,244);"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Jam Servis</strong><br></label><input class="form-control" type="time" name="jamservis" id="jamservis" placeholder="Masukkan Jam Servis" value="<?php echo $jam_servis; ?>" readonly="" style="background: rgb(234,236,244);"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                <div class="mb-3"><label class="form-label" for="username"><strong>Nomor Polisi</strong><br></label><input class="form-control" type="text" name="nomorpolisi" id="nomorpolisi" placeholder="Nomor Polisi Sesuai STNK" autocomplete="off" autofocus></div>
                                                
                                                </div>
                                            </div>
                                            <div class="text-center mb-3">
                                            <a class="btn btn-secondary btn-sm" type="submit" style="margin-right: 10px;" href="<?= base_url('c_serviceadvisor/daftarantrian') ?>"><i class="fas fa-backward"></i>&nbsp; Kembali</a>
                                            <button class="btn btn-primary btn-sm" type="submit"><i class="fas fa-plus"></i>&nbsp; Tambah Antrian</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#nomorpolisi').autocomplete({
                source: "<?php echo site_url('c_serviceadvisor/autocompleteproject'); ?>",

                select: function(event, ui) {
                    $('[name="nomorpolisi"]').val(ui.item.label);
    ...
    <script>
    console.log(<?= json_encode($console); ?>);
    console.log(<?= json_encode($console1); ?>);
    console.log(<?= json_encode($console2); ?>);
</script>
</body>
