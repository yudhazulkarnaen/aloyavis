        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">DAFTAR SERVICE ADVISOR</h3>
                    <div class="card" style="margin-top: 10px;">
                    <form class="search-form" action="<?= base_url('c_manager/daftarserviceadvisor'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Nama Service Advisor" name="keyword_serviceadvisor" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Service Advisor = <?php echo $total_rows ?></strong><br></p>
                                <?php echo $wew ?>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                            	...
                            	<?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start" style="color: rgb(0,0,0);vertical-align: middle;"><?= $a['duplicate_value']; ?></td>
                                        <td style="color: rgb(0,0,0);"><a class="btn btn-primary" role="button" href="<?= base_url('c_manager/historypekerjaanserviceadvisor/').$a['nama'] ?>">Lihat History Pekerjaan</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
