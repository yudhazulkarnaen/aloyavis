        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_manager') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= base_url('c_manager/daftarkendaraan') ?>"><strong>Daftar Kendaraan</strong></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">DAFTAR KENDARAAN</h3>
                    <div class="card" style="margin-top: 10px;">
                    <form class="search-form" action="<?= base_url('c_manager/daftarkendaraan'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Nomor Polisi" name="keyword_platnomor" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Kendaraan = <?php echo $total_rows ?></strong><br></p>
                                <?php echo $wew ?>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr class="table-primary">
                                        ...
                                        <th style="vertical-align: middle">Merk Kendaraan</th>
                                        <th style="vertical-align: middle">Tahun</th>
                                        <th style="vertical-align: middle">Isi Silinder</th>
                                        <th style="vertical-align: middle">Warna</th>
                                        <th style="vertical-align: middle">No. Chasis</th>
                            	...
                            	<?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['nomor_polisi']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['nama_pemilik']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['merk_kendaraan']; ?></span><br></td>
                                        <td class="text-start" style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['tahun_kendaraan']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['isi_silinder']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['warna_kendaraan']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['nomor_chasis']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);vertical-align: middle;"><span style="background-color: rgb(253, 253, 254);"><?= $a['nomor_mesin']; ?></span><br></td>
                                        <td style="color: rgb(0,0,0);"><a class="btn btn-primary" role="button" href="<?= base_url('c_manager/informasipemilik/').$a['nomor_polisi'] ?>"><i class="fas fa-search"></i>&nbsp;Lihat Informasi Pemilik</a><br></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
