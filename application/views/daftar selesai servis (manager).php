            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card" style="margin-top: 10px;">
                        <form class="search-form" action="<?= base_url('c_manager/daftarselesaiservis'); ?>" method="post">
                        ...
                        <div class="table-responsive" style="margin: 10px;">
                            <table class="table">
                                ...
                                $no = 1;
                                foreach ($res as $a) : 
                                    if($a['konfirmasi'] == "Sudah"){?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $a['nomor_polisi_selesai']; ?></td>
                                        <td><?= $a['tgl']; ?></td>
                                        <td><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailfakturservis/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Faktur Servis</a></td>
                                        <td><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailpemeriksaan/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Pemeriksaan</a></td>
                                        <td><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailworkorder/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail Work Order</a></td>
                                        <td><a class="btn btn-primary btn-sm" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_manager/detailqmc/').$a['nomor_polisi_selesai'].'/'.$a['tgl'] ?>"><i class="fas fa-search"></i>&nbsp;Detail QMC</a></td>
                                    </tr>
                                    <?php } ?>
                                <?php endforeach; ?>
                                </tbody>
