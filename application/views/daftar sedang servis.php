...
<head>
    ...
    <title>Daftar Sedang Servis</title>
        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_serviceadvisor') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= base_url('c_serviceadvisor/daftarsedangservis') ?>"><strong>Daftar Sedang Servis</strong></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">DAFTAR SEDANG SERVIS</h3>
                    <div class="card" style="margin-top: 10px;">
                        <form class="search-form" action="<?= base_url('c_serviceadvisor/daftarsedangservis'); ?>" method="post">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-search"></i></span>
                                <input class="form-control" type="text" placeholder="Cari Plat Nomor" name="keyword_sedangservis" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <div class="row" style="margin: 0px;margin-bottom: -15px;">
                            <div class="col-md-6">
                                <p><strong>Jumlah Kendaraan = <?php echo $total_rows ?></strong><br><strong>Tanggal&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;= <?php echo $date ?></strong></p>
                                <?php echo $wew ?>
                            </div>
                        </div>
                            ...
                            <table class="table">
                            	...
                            	<?php endif; ?>
                                    <?php foreach ($res as $a) : ?>
                                        <?php if ($a['catatan_karu'] != "BELUM ADA CATATAN") {?>
                                        <tr>
                                            <td><?= $a['nomor_pitstop']; ?></td>
                                            <td><?= $a['nomor_polisi']; ?></td>
                                            <td><?= $a['nama_pemilik']; ?></td>
                                            <td>0<?= $a['nomor_handphone']; ?></td>
                                            <td>
                                            <?php $no = 1; foreach ($part as $p) : ?>
                                                <?php if ($a['nomor_polisi'] == $p['plat_nomor_request']) {?>
                                                    <?= $no++; ?>. <?= $p['nama_part']; ?> </br>
                                                <?php }?>
                                            <?php endforeach; ?>
                                            </td>
                                            <td><?= $a['catatan_karu']; ?></td>
                                            <td><a class="btn btn-success" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_serviceadvisor/acceptrequest/').$a['nomor_polisi'] ?>"><i class="fas fa-check"></i>&nbsp;ACC Request</a></td>
                                            <td><a class="btn btn-danger" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_serviceadvisor/rejectrequest/').$a['nomor_polisi'] ?>"><i class="fas fa-times"></i>&nbsp;Tolak Request</a></td>
                                        </tr>
                                        <?php } else {?>
                                        <tr>
                                            <td><?= $a['nomor_pitstop']; ?></td>
                                            ...
                                            <td><?= $a['nama_pemilik']; ?></td>
                                            <td>0<?= $a['nomor_handphone']; ?></td>
                                            <td><?= $a['request_karu']; ?></td>
                                            <td><?= $a['catatan_karu']; ?></td>
                                            <td><a class="btn btn-secondary" role="button" style="color: rgb(255,255,255);" disabled><i class="fas fa-check"></i>&nbsp;ACC Request</a></td>
                                            <td><a class="btn btn-secondary" role="button" style="color: rgb(255,255,255);" disabled><i class="fas fa-times"></i>&nbsp;Tolak Request</a></td>
                                        </tr>
                                        <?php }?>
                                    <?php endforeach; ?>
                                </tbody>
