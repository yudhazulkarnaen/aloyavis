        ...
        <nav class="navbar navbar-dark d-sm-inline align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(9,40,71);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="<?= base_url('c_karu') ?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= base_url('c_karu/monitoringservis') ?>">Monitoring Servis</a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">PROFIL</h3>
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Username</strong><br></label><input class="form-control" type="text" id="username" placeholder="Username Anda" value="<?= $res['username'] ?>" readonly></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Nama Lengkap</strong><br></label><input class="form-control" type="text" id="username-2" placeholder="Nama Lengkap Anda" value="<?= $res['nama'] ?>" readonly></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>Nomor Pegawai</strong><br></label><input class="form-control" type="number" id="username-1" placeholder="Nomor Pegawai Anda" value="<?= $res['nip'] ?>" readonly></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="username"><strong>No. Handphone</strong><br></label><input class="form-control" type="number" id="username-7" placeholder="Nomor Handphone Anda" value="0<?= $res['handphone'] ?>" readonly></div>
                                                </div>
                                            </div>
                                            <div class="text-center mb-3"><a class="btn btn-secondary btn-sm" style="margin-right: 10px;" href="<?= base_url('c_karu') ?>"><i class="fas fa-home"></i>&nbsp; Kembali ke Halaman Utama</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
